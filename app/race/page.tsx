...
export default function RacePage() {
    ...
    return (
        <div className="relative w-full h-screen bg-black overflow-hidden select-none">
            ...
            {/* 2. Commercial HUD Overlay */}
            <div className="absolute inset-0 z-10 pointer-events-none p-6 flex flex-col justify-between">

                {/* Top Bar: Status & Sponsor */}
                ...
                <div className="pointer-events-auto flex items-end justify-between">
                    ...
                    <div className="flex flex-col items-end gap-4">
                        {/* Navigation Guide */}
                        <div className="bg-black/80 border border-white/10 p-3 rounded-lg text-right backdrop-blur">
                            ...
                            <div className="flex items-center justify-end gap-2 text-neon-cyan">
                                <span className="text-lg font-black italic">
                                    {/* Distance to Zone Center (Approx 37.5680, 126.9805) */}
                                    {/* Simple rough calc for UI responsiveness */}
